...
ServerEvents.recipes((event) => {
    ...
    //Taffy
    event.shapeless("trickortreat:taffy", [
        "minecraft:sugar",
        "minecraft:sugar",
        "minecraft:sugar",
        "create_chocolate:butter",
        "create_chocolate:vanilla_powder",
        "create:wheat_flour",
        "alltheores:salt",
    ...
    //Nougat
    event.shapeless("trickortreat:nougat_swirl", [
        "minecraft:stick",
        "minecraft:sugar",
        "minecraft:honey_bottle",
        "minecraft:egg",
        "create_chocolate:almond",
    ]).id("farmopolis:nougat_swirl");
